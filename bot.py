...
class Sparkchain:
    ...
    def welcome(self):
        ...
        """
        f"""
        {Fore.RED + Style.BRIGHT}This script is not owned by {Fore.CYAN + Style.BRIGHT}AirdropTube,
        {Fore.RED + Style.BRIGHT}but heartfelt thanks to the original creator!
        """
        f"""
        {Fore.MAGENTA + Style.BRIGHT}Join Telegram: {Fore.CYAN + Style.BRIGHT}AIRDROP TUBE (https://t.me/AirdropTube28)
        """
        )
